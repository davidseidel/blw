...
BLW_CORE_ClassLoader::import('app.lib.PSP.validator.BLW_PSP_EmailValidator');
BLW_CORE_ClassLoader::import('app.core.BLW_CORE_NullPointerException');
class emailValidatorTag extends BLW_PSP_Tag {
	public function doStartTag() {
		...
		if($component instanceof BLW_PSP_EditableValueHolder) {
			...
			$validator = new BLW_PSP_EmailValidator();
